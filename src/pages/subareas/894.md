...
Imágenes (mapas) de Sala del juicio:
...
Subzona: Necrópolis.
Mundo: Mapamundis.
Coordenadas de su ubicación: [13,14].
Imágenes (mapas) de Puente de los Últimos Suspiros:
...
Mundo: Mapamundis.
Coordenadas de su ubicación: [14,13].
Imágenes (mapas) de Sala de espera de la ciudadela:
...
Subzona: Necrópolis.
Mundo: Mapamundis.
Coordenadas de su ubicación: [12,15].
Imágenes (mapas) de Puertas de Onekros:
...
Imágenes (mapas) de Vestíbulo de la ciudadela:
...
Mundo: Mapamundis.
Coordenadas de su ubicación: [14,13].
Imágenes (mapas) de Entrada de la ciudadela:
